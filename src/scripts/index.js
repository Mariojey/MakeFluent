...
const hasEntertainSpeaking = new URLSearchParams(window.location.search).get("EnglishEntertainVocabulary")
...
checkWord(hasEntertainSpeaking,
    btnEnglish,
    btnGermany,
